...
@Composable
fun PasswordTextField(state: LoginUserStore.State, component: LoginUserComponent, context: Context) {
    val passwordColor =
        if (state.isLoginButtonEnabled) Color.Unspecified else Color.Red
